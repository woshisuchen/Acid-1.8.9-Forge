...
public class GuiAltLogin extends GuiScreen
{
    ...
    public void drawScreen(final int x, final int y, final float z) {
        ...
        FontLoaders.kiona18.drawCenteredString("Alt Login", this.width / 2, 20.0f, -1);
        FontLoaders.kiona18.drawCenteredString((this.thread == null) ? "¡ìeWaiting..." : this.thread.getStatus(), this.width / 2, 29.0f, -1);
